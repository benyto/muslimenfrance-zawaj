// Generated from i18n-iso-countries@7.14.0 (ISO 3166-1, French official names).
// Small, static, and complete — unlike communes_fr (~35k rows), a full
// country list is cheap enough to ship as a plain array and filter
// client-side, no debounced RPC autocomplete needed.
...
export const worldCountries: Country[] = [
  ...
  { code: "SZ", name: "Royaume d'Eswatini" },
...
export const worldCountryNameByCode: Record<string, string> = Object.fromEntries(
  worldCountries.map((c) => [c.code, c.name])
);
